...
MIN_TEMPERATURE_VAL = -100
MAX_TEMPERATURE_VAL = 100
MIN_EXPOSURE_VAL = -100
MAX_EXPOSURE_VAL = 100
...
INVALID_TEMPERATURE_VAL_ERR_MSG = "Temperature adjustment value should be between -100 to 100."
INVALID_EXPOSURE_VAL_ERR_MSG = "Exposure adjustment value should be between -100 to 100."
